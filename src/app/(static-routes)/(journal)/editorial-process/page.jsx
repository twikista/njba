    ...
    <Main>
      ...
      <div>
        <TextBlockWithHeading
          ...
          headingType='normal'
          text='The Management Sciences Review (MSR) accepts submissions on an ongoing basis. Authors are encouraged to submit their manuscripts at any time throughout the year. Submissions should be sent as an email attachment to msr@uniben.edu, with a copy to the Business Manager at osagie.osifo@uniben.edu.'
        />
            ...
            <div>
              ...
              <ul className='flex flex-col gap-1 pl-5 list-disc'>
                ...
                <li>
                  ...
                  Manager at osagie.osifo@uniben.edu.
                </li>
              </ul>
            </div>
          </li>
