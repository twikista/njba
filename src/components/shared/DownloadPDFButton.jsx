    ...
    <a
      ...
      className={cn(
        variant === 'basic'
          ...
          : 'flex w-full border-light-black text-light-black justify-center gap-2 px-3 py-1 border hover:border-lightPrimary md:w-fit rounded-md items-center text-center hover:text-white hover:border-black hover:bg-black transition-all duration-200 ease-in-out'
      )}
    >
      {variant === 'basic' ? (
        <>
